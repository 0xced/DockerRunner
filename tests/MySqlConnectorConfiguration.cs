...
{
    public class MySqlConnectorConfiguration : DockerDatabaseContainerConfiguration
    {
        ...
        /// <inheritdoc />
        public override DbProviderFactory ProviderFactory => MySqlConnectorFactory.Instance;
